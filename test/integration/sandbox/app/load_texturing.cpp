...
bool load_texturing(){
    ...
    Xioudown_Cat->getManager()->LoadTexture(r, "./assets/media/img/lesserImpnoalpha.png");
    Xioudown_Cat->getManager()->LoadTexture(r, "./assets/media/img/basic_stone_brick.png");
    Xioudown_Cat->getManager()->LoadTexture(r, "./assets/media/img/paulina-janzen-dungeon-floor-texture-1.jpg");
    Xioudown_Cat->getManager()->LoadTexture(r, "./assets/media/img/inventory_slot.png");
